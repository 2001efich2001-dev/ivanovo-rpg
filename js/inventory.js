...
export async function renderTitlesTab() {
    ...
    const titlesInfo = {
        ...
        "👑 Депутат": { icon: "👑", desc: "Получить депутатский мандат" }
    };
